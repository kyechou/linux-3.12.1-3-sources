...
license=('GPL2')
makedepends=('xmlto' 'docbook-xsl' 'kmod' 'inetutils' 'bc' 'gcc49')
options=('!strip')
source=("http://www.kernel.org/pub/linux/kernel/v3.x/${_srcname}.tar.xz"
        ...
        'relocs_32-relocs_64-conflict.patch'
        'disable-gcc-pie.patch'
        'use-gcc49.patch')
md5sums=('cc6ee608854e0da4b64f6c1ff8b6398c'
         ...
         '6ec48c60f2feecaf39f54eba6714fddf'
         'd2410e390d9a561bf4e97ab4ff2249c2'
         '0383bce58c64d6522c4838f363b37706')
...
prepare() {
  ...
  patch -Np1 -i "${srcdir}/relocs_32-relocs_64-conflict.patch"
  ...
  #patch -Np1 -i "${srcdir}/disable-gcc-pie.patch"

  patch -Np1 -i "${srcdir}/use-gcc49.patch"
